...
int main()
{
	...
	int imgXlen, imgYlen;
	//输入图像路径
	char* srcPath1 = "D:/softwareClass/lesson_03/picture/superman.jpg";
	char* srcPath2 = "D:/softwareClass/lesson_03/picture/space.jpg";
	//输出图像路径
	char* dstPath = "D:/softwareClass/lesson_03/picture/result.jpg";
	//图像内存存储
	GByte* buffTmpR1, *buffTmpG1, *buffTmpB1,
		 * buffTmpR2, *buffTmpG2, *buffTmpB2,
		 * buffTmpR, *buffTmpG, *buffTmpB;
	//图像波段数
	int i,j, bandNum;
